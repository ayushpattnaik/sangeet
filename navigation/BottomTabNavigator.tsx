import { Ionicons,Entypo,MaterialCommunityIcons,FontAwesome5, EvilIcons, FontAwesome} from '@expo/vector-icons';
...
export default function BottomTabNavigator() {
  ...
  return (
    <BottomTab.Navigator
      ...
      tabBarOptions={{ activeTintColor: Colors[colorScheme].tint ,inactiveBackgroundColor:'#1D1A1F', activeBackgroundColor:'green'}}>
      <BottomTab.Screen
        name="Home"
